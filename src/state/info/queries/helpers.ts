...
export const mapMints = (mint: MintResponse) => {
  return {
    ...
    sender: mint.to,
    token0Symbol: mint.curve.token0.symbol,
    token1Symbol: mint.curve.token1.symbol,
    token0Address: mint.curve.token0.id,
    token1Address: mint.curve.token1.id,
...
export const mapBurns = (burn: BurnResponse) => {
  return {
    ...
    sender: burn.sender,
    token0Symbol: burn.curve.token0.symbol,
    token1Symbol: burn.curve.token1.symbol,
    token0Address: burn.curve.token0.id,
    token1Address: burn.curve.token1.id,
...
export const mapSwaps = (swap: SwapResponse) => {
  return {
    ...
    sender: swap.from,
    token0Symbol: swap.curve.token0.symbol,
    token1Symbol: swap.curve.token1.symbol,
    token0Address: swap.curve.token0.id,
    token1Address: swap.curve.token1.id,
